 ...
 * /app2app/mobile/projects/{projectId}/attestation/{challenges,registrations}
 * device-attestation endpoints (plus legacy PUT .../registrations/{keyId}).
 * Vercel's file-based routing only exposes files under api/, so this
